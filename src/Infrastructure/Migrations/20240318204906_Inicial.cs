        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeactivationComment = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandVehicleTypes", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    BrandVehicleTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Models", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Models_BrandVehicleTypes_BrandVehicleTypeId",
                        column: x => x.BrandVehicleTypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_BrandVehicleTypes_BrandVehicleTypeId",
                        column: x => x.BrandVehicleTypeId,
                        principalTable: "BrandVehicleTypes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandVehicleTypes_BrandId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Models_BrandVehicleTypeId",
                table: "Models",
                column: "BrandVehicleTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_BrandVehicleTypeId",
                table: "Vehicles",
                column: "BrandVehicleTypeId");
